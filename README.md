...
```bash
cat secrets/aicacia-api-env-secret.yaml | kubeseal --controller-namespace kube-system --controller-name sealed-secrets --format yaml > apps/production/configs/aicacia-api-env-secret.yaml
```
